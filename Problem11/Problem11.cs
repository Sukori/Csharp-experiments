/*
In the 20×20 grid below, four numbers along a diagonal line have been marked in red... LOL they are in [square brackets] here
...
Wow...
On peut faire une méthode par orientation pour tester 4 nombres adjacents.
Attention à gérer les sorties des plages de la grille.

Bruteforce : On parcourt la grille en passant en paramètre chaque nombre, et pour chaque nombre, on regarde autour en éventail direction positive à la recherche des trois nombres adjacents s'ils existent.
...
From stackoverflow: Si je ne sais pas en avance la taille de mon array
...
Mais là je sais:
int[,] array = new int[20, 20] {{08, 02, ..., 08},{49, 49, ..., 00}, ...};
...
namespace ProjectEuler
{
    public class Problem11
    {
        ...
        public static void LargestProductInAGrid()
        {
            ...
            Console.WriteLine("Le plus grand produit de quatre nombres dans ce tableau vaut : " + result);
            Console.ReadKey();
        }
    }
}